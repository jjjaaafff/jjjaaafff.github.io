...
我们之所以想把 causal quantities (e.g. E[Y(1)]) 变成 statistical quantities (e.g. E[Y|T=1])，就是因为后者可以从 P(x,t,y) 的联合概率分布中得到，由此引出 identifiability的概念。  
我们称一个 causal quantities (e.g. E[Y(t)])是 identifiable，如果它可以由statistical quantities (e.g. E[Y|t])计算得到
